...
### Which one to use? (need to revise)
...
**Preferred**:
```swift
result = boolWithTooLongNameWhichYouCantShortenAtAll 
    ? firstVariableWithTooLongNameWhichYouCantShortenAtAll 
    : secondVariableWithTooLongNameWhichYouCantShortenAtAll
```
